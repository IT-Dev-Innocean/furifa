...
export function RegistrationStyledSelect({
  ...
  return (
    <Select.Root
      ...
      <Select.Portal>
        <Select.Content
          className='z-50 max-h-[min(320px,var(--radix-select-content-available-height))] overflow-hidden rounded-[10px] border border-neutral-200 bg-white p-1 shadow-lg'
          position='popper'
          sideOffset={6}
          align='start'
